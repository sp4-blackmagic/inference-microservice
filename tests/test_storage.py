...
class TestFetchFile:
    ...
    @pytest.mark.asyncio
    async def test_fetch_file_http_status_error(self):
    ...
    @pytest.mark.asyncio
    async def test_fetch_file_request_error(self):
    ...
    @pytest.mark.asyncio
    async def test_fetch_file_generic_exception(self):
...
class TestListDirs:
    ...
    def test_list_dirs_with_existing_dirs(self):
    ...
    def test_list_dirs_nonexistent_directory(self):
...
class TestListFilesWithExtension:
    ...
    def test_list_files_with_extension_without_dot(self):
...
class TestModelRegistry:
    """Tests for model registry related functions."""

    def create_model_directory(self, base_dir, model_dir, model_type, prediction_type):
    ...
    def test_build_model_registry_nonexistent_directory(self):
